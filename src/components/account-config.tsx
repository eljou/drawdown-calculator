...
export default function AccountConfig(props: { balance: number; setNewBalance: (newBalance: number) => void }) {
  ...
  return (
    <div className="card">
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "3rem" }}>
        ...
        <AddOrder validSymbols={Object.keys(symbolConfigs)} onAddOrder={addNewOrder} />
      </div>
    </div>
  );
}
