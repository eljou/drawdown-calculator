		...
		<div className="card">
			<div className="label-row" style={{ alignItems: "flex-end" }}>
				...
				<AddDummyOrders
					...
					addEstimatedOrders={addEstimatedOrders}
				/>
			</div>
						...
						{orders.length === 0 ? (
							...
							orders.map((o, index) => (
								<tr key={o.id}>
									...
									<td className={symbolConfigs[o.symbol].colorClass}>
										{o.lots.toFixed(2)} {o.symbol}
									</td>
									<td
										style={{ textAlign: "right" }}
										className={o.currentPnL >= 0 ? "text-green" : "text-red"}
									>
										{o.currentPnL >= 0 ? "+" : ""}${o.currentPnL.toFixed(2)}
									</td>
									<td
										style={{ textAlign: "right" }}
										className={o.totalPnL >= 0 ? "text-green" : "text-red"}
									>
